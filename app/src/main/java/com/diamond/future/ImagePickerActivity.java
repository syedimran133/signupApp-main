...
public class ImagePickerActivity extends AppCompatActivity {
  ...
  /*  private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.gold));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.gold_status));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.gold));
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImagePickerActivity.this, "com.diamond.signupapp.fileprovider", image);
    }
